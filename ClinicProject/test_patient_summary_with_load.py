...
from api.ai_client import load_local_model, is_model_loaded, get_model_name

def test_patient_summary_with_load():
    print("Testing Patient Summary with Model Loading...")
    
    # First, load the model locally
    ...
    if not success:
        print("Failed to load model locally")
        return False
...
if __name__ == "__main__":
    success = test_patient_summary_with_load()
